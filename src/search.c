...
float searching(engine_t *eng, cb_board_t *board, cb_state_tables_t *state, int depth)
{
    cb_mvlst_t mvlst;
    cb_move_t mv;
    float value = FLT_MAX;
...
cb_move_t alphabeta(engine_t *eng, cb_board_t *board, int base_depth)
{
    cb_errno_t result;
    cb_error_t err;
...
cb_move_t iterative_deepening(engine_t *eng, cb_board_t *board)
{
    cb_move_t best_move;
    cb_move_t result;
    int i;
