...
const uint64_t BB_BLACK_PAWN_HOME  = 0x00FF000000000000; /* Second-to-top row */
const uint64_t BB_WHITE_PAWN_HOME  = 0x000000000000FF00; /* Second-to-bottom row */
...
const uint64_t BB_BLACK_KING_SIDE_CASTLE_CHECK      = 0x7000000000000000;
const uint64_t BB_BLACK_QUEEN_SIDE_CASTLE_CHECK     = 0x1C00000000000000;
